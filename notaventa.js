...
exports.edit = async (req, res) => {
  try {
    ...
    if ((notaventa.precioventa==undefined)||(notaventa.numero1==null)) {notaventa.precioventa=0}
    if ((notaventa.numero01==undefined)||(notaventa.numero1==null)) {notaventa.numero01=0}
  ...
  try {
    ...
    for (i = 1; i < arr0.length; i++) {
      ...
      // console.log("nv.estado>>>>>> ", nv.estado)
        ...
        res = nv._id + "," + nv.idnotaventa + "," + nv.cant + ","+ nv.estado+ "," + nv.fecha + "," + nv.quien+ "," +nv.nombreorganizacion
        // console.log("res>>>>>> ", res)
