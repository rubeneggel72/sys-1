  ...
  try {
    ...
    for (i = 1; i < arr0.length; i++) {
      ...
      // console.log("nv.estado>>>>>> ", nv.estado)
        ...
        res = nv._id + "," + nv.idordencompra + "," + nv.cant + ","+ nv.estado+ "," + nv.fecha + "," + nv.quien+ "," +nv.nombreorganizacion
        // console.log("res>>>>>> ", res)
...
exports.postAdd = async (req, res) => {
  ...
  let j = 4 - ids.idordencompra.length;
  for (j; j > 0; j--) {
    ids.idordencompra = '0' + ids.idordencompra;
  }
  ids.idordencompra = 'V' + ids.idordencompra;
